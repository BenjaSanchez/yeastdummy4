...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "BenjaSanchez/yeastdummy4" ]]; then
...
echo "Your new report will be visible at https://BenjaSanchez.github.io/yeastdummy4 in a moment."
